...
const WhyUsSection = () => {
  return (
    <section id="why-us" className="py-20 lg:py-28 bg-navy-gradient text-navy-foreground">
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {reasons.map((reason, index) => (
            <div
              key={reason.title}
              className="group p-6 rounded-2xl border border-navy-foreground/10 hover:border-accent/30 bg-navy-foreground/5 hover:bg-navy-foreground/10 transition-all duration-300"
            >
